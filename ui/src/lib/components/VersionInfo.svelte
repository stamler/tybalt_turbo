...
{:else if versionInfo}
  <div class="relative">
    ...
    {#if showDetails}
      <div
        class="absolute top-full right-0 z-50 mt-1 w-56 rounded-md border border-neutral-600 bg-neutral-800 p-3 text-xs text-white shadow-lg lg:fixed lg:top-12 lg:right-4 lg:w-48"
      >
        <div class="space-y-1">
