...
func AddRoutes(app core.App) {
	...
	app.OnServe().BindFunc(func(se *core.ServeEvent) error {
		...
		tsGroup.POST("/{id}/uncommit", createUncommitRecordHandler(app, "time_sheets"))
		...
		adminProfilesGroup.GET("/active_toggle_targets", createGetAdminProfileActiveToggleTargetsHandler(app))
		...
		adminProfilesGroup.POST("/{id}/active", createSetAdminProfileActiveHandler(app))
		...
		// Claims management (detail endpoint requires admin claim)
