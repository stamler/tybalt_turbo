...
func TestValidateExpense(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"invalid_vendor_required_for_expense":                          {valid: false, field: "vendor", po: nil, hasPayablesAdminClaim: false, record: buildRecordFromMap(expensesCollection, map[string]any{"allowance_types": []string{}, "date": "2024-01-22", "description": "Valid description", "job": "", "payment_type": "Expense", "purchase_order": "", "total": 10.00, "vendor": ""})},
		...
		"invalid_vendor_required_for_fuelcard":                         {valid: false, field: "vendor", po: nil, hasPayablesAdminClaim: false, record: buildRecordFromMap(expensesCollection, map[string]any{"allowance_types": []string{}, "date": "2024-01-22", "description": "Valid description", "job": "", "payment_type": "FuelCard", "purchase_order": "", "total": 10.00, "vendor": ""})},
		"invalid_vendor_required_for_corporate_credit_card":            {valid: false, field: "vendor", po: nil, hasPayablesAdminClaim: false, record: buildRecordFromMap(expensesCollection, map[string]any{"allowance_types": []string{}, "date": "2024-01-22", "description": "Valid description", "job": "", "payment_type": "CorporateCreditCard", "purchase_order": "", "total": 10.00, "cc_last_4_digits": "1234", "vendor": ""})},
