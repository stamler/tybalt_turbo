...
func TestValidateTimeEntry(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"valid with job":            {timeTypeCode: "R", valid: true, record: buildRecordFromMap(timeEntriesCollection, map[string]any{"time_type": "dummy", "date": "2024-01-22", "division": "DE", "meals_hours": 0.5, "hours": 6.5, "job": "mg0sp9iyjzo4zw9", "description": "This is more than 5 chars", "work_record": "F23-137", "payout_request_amount": 0.0, "role": "tbgoiwwwfj8cvju"})},
		...
		"description too short":     {timeTypeCode: "R", valid: false, field: "description", record: buildRecordFromMap(timeEntriesCollection, map[string]any{"time_type": "dummy", "date": "2024-01-22", "division": "DE", "meals_hours": 0.5, "hours": 5.0, "job": "mg0sp9iyjzo4zw9", "description": "tiny", "work_record": "", "payout_request_amount": 0, "role": "tbgoiwwwfj8cvju"})},
		"closed job":                {timeTypeCode: "R", valid: false, field: "job", record: buildRecordFromMap(timeEntriesCollection, map[string]any{"time_type": "dummy", "date": "2024-01-22", "division": "DE", "hours": 1.0, "job": "zke3cs3yipplwtu", "description": "This is more than 5 chars", "role": "tbgoiwwwfj8cvju"})},
