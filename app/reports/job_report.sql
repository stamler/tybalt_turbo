-- This is almost the same as weekly_time.sql report but we
-- specify the job and omit the date range. It's surfaced in 
-- the UI as a "Full Time Report" on the Job Details page.
-- The parameters are:
-- - job_id: the job ID
-- - company_short_name: the company short name
