...
func init() {
	m.Register(func(app core.App) error {
		...
		// remove field
		collection.Fields.RemoveById("_clone_1P7T")

		// remove field
		collection.Fields.RemoveById("_clone_vn6n")

		// remove field
		collection.Fields.RemoveById("_clone_S4ov")

		// remove field
		collection.Fields.RemoveById("_clone_Mi6e")
